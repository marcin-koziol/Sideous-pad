/*
 * Sideous Pad - basic SID/POKEY-vibe oscillator (saw, pulse w/ PWM,
 * triangle). Uses PolyBLEP band-limiting on saw/pulse edges to keep
 * aliasing sane. Copied verbatim from sideous; UnisonOscillator.hpp
 * instantiates several of these per voice.
 */
