/*
 * Sideous Pad - state-variable filter (TPT/Zavalishin topology), switchable
 * lowpass/highpass/bandpass, stable under fast cutoff modulation. Copied
 * verbatim from sideous; used here as the general post-formant tone stage
 * (separate from FormantFilter.hpp's fixed-purpose vowel bandpass bank).
 */
