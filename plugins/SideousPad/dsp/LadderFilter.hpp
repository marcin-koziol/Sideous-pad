/*
 * Sideous Pad - simplified 4-pole digital ladder filter (Moog-style), for
 * the "LADDER 24dB" filter mode. Not a precise analog model, just four
 * one-pole lowpass stages in series with global feedback and a saturating
 * input, enough to get the characteristic squelchy self-oscillating 24dB
 * slope. Copied verbatim from sideous.
 */
