...
#define DISTRHO_PLUGIN_NAME    "Sideous Pad"
#define DISTRHO_PLUGIN_URI     "https://github.com/sideous/sideous-pad"
#define DISTRHO_PLUGIN_CLAP_ID "sideous.sideouspad"

#define DISTRHO_PLUGIN_BRAND_ID  Side
#define DISTRHO_PLUGIN_UNIQUE_ID Pad1
