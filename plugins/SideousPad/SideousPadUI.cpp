/*
 * Sideous Pad - custom retro-styled Cairo UI. All drawing/layout logic
 * lives in ui/UIPainter.hpp (shared with an offline PNG renderer used during
 * design); this file only wires mouse input to parameter changes. Copied
 * near-verbatim from sideous-noise's SideousNoiseUI.cpp - generic mouse/
 * hit-testing logic, nothing pad-specific here.
 */
...
private:
    ...
    DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SideousPadUI)
};
