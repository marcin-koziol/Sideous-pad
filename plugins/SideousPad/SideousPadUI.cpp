/*
 * Sideous Pad - custom retro-styled Cairo UI. Drawing/layout logic lives in
 * ui/UIPainter.hpp (shared with an offline PNG renderer used during
 ...
 * that. Copied near-verbatim from sideous-bass's SideousBassUI.cpp.
 */
